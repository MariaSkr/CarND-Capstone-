...
class TLDetector(object):
    ...
    # /vehicle/traffic_lights is published around 50hz
    def traffic_cb(self, msg):
        self.lights = msg.lights
        self.traffic_cb_count += 1
        if not self.config['is_site'] and not self.has_image:
            if self.traffic_cb_count % 5 == 0:
                # Rate control: publish upcoming red light at around 10hz
    ...
    def process_traffic_lights(self):
        ...
        if (self.pose):
            ...
            for i,light in enumerate(self.lights):
                ...
                # find closest stop line wp index
